...
function Bg() {
    return (
      <div className='w-screen h-screen  flex '>
        ...
        <div className='w-full flex justify-between pt-0 mt-0 '>
          <p className='flex flex-col '>Maëlle Moisis</p>
          <p className='flex flex-col '>Lucas Camsing</p>
          <p className='flex flex-col '>Kilian Thivet</p>
          <p className='flex flex-col '>Léonie Nollevalle</p>
          </div>

          <div className="w-full flex flex-col ">
          <h1 className='uppercase font-bold flex flex-col pt-5 pb-0 mb-0 text-xl'>Paysage Typographique</h1>
          <a href="https://www.figma.com/file/qHA8mD3CWG36KqBeiCmAX0/Paysage-Typographique?type=whiteboard&node-id=85%3A73&t=3HT06gPLK6meh1OF-1" className='flex items-center gap-2 bg-gray-200 rounded-lg p-3 my-2'> 
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M12.25 2.834c-.46-.078-1.088-.084-2.22-.084c-1.917 0-3.28.002-4.312.14c-1.012.135-1.593.39-2.016.812c-.423.423-.677 1.003-.812 2.009c-.138 1.028-.14 2.382-.14 4.29v4c0 1.906.002 3.26.14 4.288c.135 1.006.389 1.586.812 2.01c.423.422 1.003.676 2.009.811c1.028.139 2.382.14 4.289.14h4c1.907 0 3.262-.002 4.29-.14c1.005-.135 1.585-.389 2.008-.812c.423-.423.677-1.003.812-2.009c.138-1.027.14-2.382.14-4.289v-.437c0-1.536-.01-2.264-.174-2.813h-3.13c-1.133 0-2.058 0-2.79-.098c-.763-.103-1.425-.325-1.954-.854c-.529-.529-.751-1.19-.854-1.955c-.098-.73-.098-1.656-.098-2.79zm1.5.776V5c0 1.2.002 2.024.085 2.643c.08.598.224.891.428 1.094c.203.204.496.348 1.094.428c.619.083 1.443.085 2.643.085h2.02a45.815 45.815 0 0 0-1.17-1.076l-3.959-3.563A37.2 37.2 0 0 0 13.75 3.61m-3.575-2.36c1.385 0 2.28 0 3.103.315c.823.316 1.485.912 2.51 1.835l.107.096l3.958 3.563l.125.112c1.184 1.065 1.95 1.754 2.361 2.678c.412.924.412 1.954.411 3.546v.661c0 1.838 0 3.294-.153 4.433c-.158 1.172-.49 2.121-1.238 2.87c-.749.748-1.698 1.08-2.87 1.238c-1.14.153-2.595.153-4.433.153H9.944c-1.838 0-3.294 0-4.433-.153c-1.172-.158-2.121-.49-2.87-1.238c-.748-.749-1.08-1.698-1.238-2.87c-.153-1.14-.153-2.595-.153-4.433V9.945c0-1.838 0-3.294.153-4.433c.158-1.172.49-2.121 1.238-2.87c.75-.749 1.701-1.08 2.878-1.238c1.144-.153 2.607-.153 4.455-.153h.056z"/><path d="M4.25 11.5A2.25 2.25 0 0 1 6.5 9.25h3A2.25 2.25 0 0 1 11.177 13a2.25 2.25 0 0 1-2.427 3.622v.878A2.25 2.25 0 1 1 4.823 16a2.242 2.242 0 0 1-.573-1.5c0-.576.217-1.102.573-1.5a2.242 2.242 0 0 1-.573-1.5m2.25 2.25a.75.75 0 1 0 0 1.5h.75v-1.5zm.75-1.5H6.5a.75.75 0 0 1 0-1.5h.75zm2.25 0a.75.75 0 0 0 0-1.5h-.75v1.5zm0 1.5a.75.75 0 1 0 0 1.5a.75.75 0 0 0 0-1.5m-2.25 3H6.5a.75.75 0 1 0 .75.75z"/></g></svg>
          ...
          <br/>
          <br/>
          Notre volonté est de faire une nouvelle version de police organique liée à la nature.
          La typographie Gosna nous a servi de support pour créer des lettres uniques, réalisées en utilisant un effet de miroir pour créer une dualité <span className="font-bold">(fig.3)</span>. 
          <br/>
          <br/>
        ...
        <div className="w-full flex justify-between gap-3 pt-10 ">
          ...
          <path d="M101.624 322.548C100.822 322.756 100.34 323.574 100.548 324.376L103.932 337.445C104.139 338.247 104.958 338.729 105.76 338.521C106.562 338.313 107.044 337.495 106.836 336.693L103.828 325.076L115.445 322.068C116.247 321.861 116.729 321.042 116.521 320.24C116.313 319.438 115.495 318.956 114.693 319.164L101.624 322.548ZM273.706 322.727C219.712 356.412 158.713 355.643 102.761 322.707L101.239 325.293C158.087 358.757 220.288 359.588 275.294 325.273L273.706 322.727Z" fill="black"/>
          </svg>
          </div>
        ...
        <div className='w-1/2 h-2/3 bg-red-600 flex flex-wrap h-screen overflow-y-scroll'>

          <div className="w-full h-2/3 bg-green-100">
          <iframe title="herbe" className='w-full h-full' src="https://editor.p5js.org/LeonieNollevalle/full/Uln4uEBjB"></iframe>
          </div>
          <div className="w-full h-2/3 bg-yellow-100">
          <iframe title='sable' className='w-full h-full' src="https://editor.p5js.org/LeonieNollevalle/full/QcxIvNIbN"></iframe>
          </div>
          <div className="w-full h-2/3 bg-red-100">
          <iframe title='feu' className='w-full h-full' src="https://editor.p5js.org/LeonieNollevalle/full/_t1niu3pR"></iframe>
          </div>
          <div className="w-full h-2/3 bg-blue-100">
          <iframe title='bulle' className='w-full h-full' src="https://editor.p5js.org/LeonieNollevalle/full/QYJ3UDVbR"></iframe>
          </div>
        </div>
     </div>
    )
